...
-- bypassing Row Level Security on public.profiles to completely prevent infinite recursion.
...
DROP POLICY IF EXISTS "Allow individual read of own profile" ON public.profiles;
...
BEGIN
  ...
  VALUES (
    ...
    new.email, 
    CASE 
      WHEN LOWER(new.email) = 'prajwalgadade9606@gmail.com' OR LOWER(new.email) = 'prajwalgadade96@gmail.com' OR LOWER(new.email) = 'prajwalgadade20@gmail.com' THEN 'admin'
      ELSE 'user'
    END
  );
  RETURN NEW;
...
SET role = 'admin'
WHERE LOWER(email) IN ('prajwalgadade9606@gmail.com', 'prajwalgadade96@gmail.com', 'prajwalgadade20@gmail.com');
...
DROP POLICY IF EXISTS "Allow admin write access to movies" ON public.movies;
